...
import es.plexus.android.plexuschuck.domainlayer.feature.detail.DetailDomainLayerBridgeImpl
...
import es.plexus.android.plexuschuck.domainlayer.feature.splash.SplashDomainLayerBridgeImpl
...
val domainLayerModule = module(override = true) {
    // bridge
    factory<SplashDomainLayerBridge>(named(name = SPLASH_DOMAIN_BRIDGE_TAG)) { SplashDomainLayerBridgeImpl() }
    ...
    factory<DetailDomainLayerBridge>(named(name = DETAIL_DOMAIN_BRIDGE_TAG)) { DetailDomainLayerBridgeImpl() }
    // use-case
